...
class Response(TypedDict):
    key_themes: Annotated[list[str], "The key themes or topics mentioned in the text"]
    summary: Annotated[str, "A brief summary of the text"]
    sentiment: Annotated[Literal["pos", "neg", "neutral"], "The sentiment of the text"]
    metadata: Annotated[dict, "Additional metadata about the text"]
    pros: Annotated[Optional[list[str]], "A list of positive aspects mentioned in the text"]
    cons: Annotated[Optional[list[str]], "A list of negative aspects mentioned in the text"]
